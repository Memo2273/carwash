...
<body>
  <section class="form-register">
    ...
    <form action="ejemploper.html" name="inicio" method="POST"> 
    ...
    <?php
      ...
      $usuario = "root";
      $contraseÃ±a = "";
      $conexion = mysql_connect($puerto, $usuario, $contraseÃ±a) or die("Error, revise la conexión al servidor local");
      mysql_select_db("sistema", $conexion) or die("Error, revise la conexión a la base de datos");
